...
(function () {
  ...
  const KO = {
    ...
    /* ---- Gallery ---- */
    "gallery.issue": "필드 노트 · 제1호",
    "gallery.kicker": "연구 여정의 비주얼 저널",
    "gallery.title": "연구,<br><em>길 위에서.</em>",
    "gallery.intro": "논문이 페이지를 벗어나 강연, 포스터 세션, 협업, 그리고 그 여정을 품은 도시들과 만나는 순간을 기록합니다.",
    "gallery.cover_note": "2024년 요코하마와 시애틀에서 2026년 바르셀로나와 서울까지, 모든 여정은 더 가볍고 빠르며 신뢰할 수 있는 AI를 향한 같은 탐구의 일부가 되었습니다.",
    "gallery.contents_kicker": "목차",
    "gallery.contents_title": "시간순 연구 여정",
    "gallery.contents_note": "가장 최근의 기록부터 이어집니다.",
    "gallery.year26": "효율적 추론과 강건한 에이전트, 그리고 로스앤젤레스·바르셀로나·서울을 잇는 연구의 여름.",
    "gallery.icassp_title": "바르셀로나에서 만난 신호",
    "gallery.icassp_body": "ICASSP 2026에서 ‘Sharpness-Aware Minimization with Z-Score Gradient Filtering’은 원고를 넘어 대화가 되었습니다. USC GSG 출장 지원금과 함께한 발표는 최적화 연구를 더 넓은 신호처리 커뮤니티와 연결했고, 바르셀로나라는 도시도 연구의 한 페이지가 되었습니다.",
    "gallery.cap_icassp_poster": "결과가 질문으로 이어지는 포스터 세션.",
    "gallery.cap_between_sessions": "세션과 세션 사이.",
    "gallery.icml_title": "시스템으로 채운 여름",
    "gallery.icml_body": "서울대학교 컴퓨팅·메모리 아키텍처 연구실 방문연구와 삼성전자 강의를 함께한 서울의 여름은 ICML 주간으로 이어졌습니다. 프루닝, 최적화, 강건한 멀티에이전트 시스템에 관한 포스터들이 E-AI 프로젝트의 여러 갈래를 한 공간에 모았습니다.",
    "gallery.cap_icml_poster": "여러 연구의 흐름이 한 포스터 홀에 모인 순간.",
    "gallery.cap_icml_floor": "코엑스의 콘퍼런스 현장.",
    "gallery.fort_title": "논문과 논문 사이의 시간",
    "gallery.fort_body": "연구는 마감 사이에 쌓이는 공동체이기도 합니다. USC FoRT-ML 연구진과 함께한 봄 소풍과 볼링은 논문을 떠받치는 조용한 기반인 신뢰와 비평, 그리고 함께 보낸 시간을 보여줍니다.",
    "gallery.cap_fort": "연구실 밖의 FoRT-ML.",
    "gallery.interlude_label": "필드 노트",
    "gallery.interlude": "“학회는 연구를 발표하는 곳만이 아니다. 하나의 아이디어가 자신이 태어난 방 바깥의 사람들에게 말하는 법을 배우는 곳이다.”",
    "gallery.year25": "최적화가 전면에 나선 해. 샌디에이고의 워크숍 포스터에서 필라델피아의 첫 AAAI까지.",
    "gallery.neurips_title": "대화가 된 최적화",
    "gallery.neurips_body": "NeurIPS OPT 워크숍에서 저정밀도 학습, Z-score 그래디언트 필터링, 자동 스케일 정규화 연구는 학습의 작동 원리 자체에 집중하는 연구자들을 만났습니다. 가장 유익한 순간은 가정과 결과를 실시간으로 검토한 포스터 옆의 대화였습니다.",
    "gallery.cap_neurips_talk": "포스터 옆에서 이어진 토론.",
    "gallery.cap_inside_venue": "NeurIPS 현장 안에서.",
    "gallery.aaai_title": "처음 마주한 AAAI",
    "gallery.aaai_body": "AAAI 워크숍은 skip-connected network의 학습을 가속하는 그래디언트 정규화 기법 ZNorm을 더 넓은 AI 연구 공동체에 소개한 자리였습니다. 필라델피아의 오래된 장소들과 새로운 연구 커뮤니티 사이를 오간 짧고 밀도 높은 여정이었습니다.",
    "gallery.cap_philadelphia": "세션 사이에 만난 필라델피아.",
    "gallery.cap_old_new": "오래된 장소, 새로운 질문.",
    "gallery.year24": "최적화, 우주 AI, 신경망, 의료영상. 서로 다른 네 개의 무대에서 시작된 연구 여정.",
    "gallery.bigdata_title": "수도에서 이야기한 그래디언트",
    "gallery.bigdata_body": "BPOD 최적화 워크숍에서는 깊은 잔차 신경망의 그래디언트 중첩과 정규화가 어려운 비볼록 최적화를 어떻게 바꿀 수 있는지를 다뤘습니다. 2024년 마지막 학회 출장은 집중도 높은 기술 발표와 겨울의 워싱턴 산책을 함께 남겼습니다.",
    "gallery.cap_bigdata_talk": "BPOD 워크숍 발표 현장.",
    "gallery.esa_title": "태양을 향한 AI",
    "gallery.esa_body": "ESA SPAICE에서는 AI가 익숙한 벤치마크를 벗어나 태양과학을 향했습니다. 컴퓨터 비전과 ARIMA-LSTM 모델링으로 태양 코로나 홀을 분석하고 예측한 연구는 효율적이고 신뢰할 수 있는 학습이 전통적인 컴퓨팅의 경계를 훨씬 넘어 중요하다는 점을 보여주었습니다.",
    "gallery.cap_esa_talk": "태양 데이터에서 시작된 지상의 대화.",
    "gallery.cap_london": "학회를 마친 뒤의 런던.",
    "gallery.ijcnn_title": "첫 구두 발표 무대",
    "gallery.ijcnn_body": "‘Robust Neural Pruning with Gradient Sampling Optimization for Residual Neural Networks’는 IJCNN 2024 구두 발표 논문으로 소개되었습니다. 요코하마는 모델 압축 연구가 국제무대에 오른 초기의 순간이자, 하나의 연구 방향이 지속적인 프로그램으로 확장되기 시작한 지점이었습니다.",
    "gallery.cap_ijcnn_talk": "IJCNN 2024 구두 발표 현장.",
    "gallery.cap_yokohama": "밤의 요코하마.",
    "gallery.cvpr_title": "불확실성을 보이게 하다",
    "gallery.cvpr_body": "CVPR CVMI 워크숍에서는 비라벨 데이터를 활용한 종양 예측을 통해 불확실성 추정과 의료영상이 만났습니다. 시애틀에서의 발표는 신뢰할 수 있는 AI가 효율성뿐 아니라 모델이 언제 주저해야 하는지를 아는 문제이기도 하다는 시야를 열어주었습니다.",
    "gallery.cap_cvpr_poster": "CVMI 포스터 세션에서 이야기한 신뢰할 수 있는 AI.",
    "gallery.cap_seattle": "시애틀을 걷다.",
    "gallery.endnote": "기록은 계속됩니다. 한 편의 논문, 한 번의 대화, 그리고 한 도시씩.",
